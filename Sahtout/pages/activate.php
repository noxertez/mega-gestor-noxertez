...
echo translate('meta_description', 'Activate your account to join our World of Warcraft server adventure!'); ?>">
    <meta name="robots" content="index">
    <title><?php
echo $site_title_name ." ". translate('page_title', 'Activate Account'); ?></title>
    <style>
       :root{
            --bg-activate:url('<?php
...
<body class="activate_account">
    <main>
        <section class="register-container">
            <h1 class="register-title"><?php
echo translate('activate_title', 'Activate Your Account'); ?></h1>
            <?php
if (!empty($errors)): ?>
...
echo htmlspecialchars($success); ?></p>
                    <p class="login-link-container"><?php
echo sprintf(translate('login_link', '<a href="%s">Click here to login</a>'), htmlspecialchars($base_path . 'login')); ?></p>
                </div>
            <?php
endif; ?>
        </section>
