...
echo translate('admin_chars_meta_description', 'Character Management for Sahtout WoW Server'); ?>">
    <meta name="robots" content="noindex">
    <title><?php
echo translate('admin_chars_page_title', 'Character Management'); ?></title>
    <link rel="icon" href="<?php
echo $base_path . $site_logo; ?>" type="image/x-icon">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php
echo $base_path; ?>assets/css/admin/characters.css">
    <link rel="stylesheet" href="<?php
...
echo translate('admin_chars_title', 'Character Management'); ?></h1>
                    <?php
echo $update_message; ?>
                    <!-- Debug Output: Display number of characters fetched -->
                    <div class="alert alert-info">
                        <?php
echo sprintf(translate('admin_chars_found_chars', 'Found %d characters on this page (Total: %d).'), count($characters), $total_chars); ?>
                    </div>
                    <!-- Search and Sort Form -->
                    <form class="search-form" method="GET" action="<?php
echo $base_path; ?>admin/characters">
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="search_char_name" class="form-label"><?php
echo translate('admin_chars_label_char_name', 'Character Name'); ?></label>
                                <input type="text" name="search_char_name" id="search_char_name" class="form-control" value="<?php
echo htmlspecialchars($search_char_name); ?>" placeholder="<?php
echo translate('admin_chars_placeholder_char_name', 'Enter character name'); ?>">
                            </div>
                            <div class="col-md-3">
                                <label for="search_username" class="form-label"><?php
echo translate('admin_chars_label_username', 'Username'); ?></label>
                                <input type="text" name="search_username" id="search_username" class="form-control" value="<?php
echo htmlspecialchars($search_username); ?>" placeholder="<?php
echo translate('admin_chars_placeholder_username', 'Enter username'); ?>">
                            </div>
                            <div class="col-md-3">
                                <label for="min_level" class="form-label"><?php
echo translate('admin_chars_label_min_level', 'Min Level'); ?></label>
                                <input type="number" name="min_level" id="min_level" class="form-control" value="<?php
echo htmlspecialchars($min_level); ?>" placeholder="<?php
echo translate('admin_chars_placeholder_min_level', 'e.g., 1'); ?>" min="1" max="255">
                            </div>
                            <div class="col-md-3">
                                <label for="max_level" class="form-label"><?php
echo translate('admin_chars_label_max_level', 'Max Level'); ?></label>
                                <input type="number" name="max_level" id="max_level" class="form-control" value="<?php
echo htmlspecialchars($max_level); ?>" placeholder="<?php
echo translate('admin_chars_placeholder_max_level', 'e.g., 255'); ?>" min="1" max="255">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="online_filter" class="form-label"><?php
echo translate('admin_chars_label_online_status', 'Online Status'); ?></label>
                                <select name="online_filter" id="online_filter" class="form-select">
                                    <option value="" <?php
echo $online_filter === '' ? 'selected' : ''; ?>><?php
echo translate('admin_chars_option_all', 'All'); ?></option>
                                    <option value="online" <?php
echo $online_filter === 'online' ? 'selected' : ''; ?>><?php
echo translate('admin_chars_option_online', 'Online'); ?></option>
                                    <option value="offline" <?php
echo $online_filter === 'offline' ? 'selected' : ''; ?>><?php
echo translate('admin_chars_option_offline', 'Offline'); ?></option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label for="sort_id" class="form-label"><?php
echo translate('admin_chars_label_sort_id', 'Sort by ID'); ?></label>
                                <select name="sort_id" id="sort_id" class="form-select">
                                    <option value="asc" <?php
echo $sort_id === 'asc' ? 'selected' : ''; ?>><?php
echo translate('admin_chars_option_sort_asc', 'Ascending'); ?></option>
                                    <option value="desc" <?php
echo $sort_id === 'desc' ? 'selected' : ''; ?>><?php
echo translate('admin_chars_option_sort_desc', 'Descending'); ?></option>
                                </select>
                            </div>
                            <div class="col-md-6 d-flex align-items-end">
                                <button type="submit" class="btn btn-primary"><?php
echo translate('admin_chars_search_button', 'Search'); ?></button>
                                <?php
if ($search_char_name || $search_username || $online_filter !== '' || $min_level !== '' || $max_level !== ''): ?>
                                    <a href="<?php
echo $base_path; ?>admin/characters" class="btn btn-secondary ms-2"><?php
echo translate('admin_chars_clear_filters', 'Clear Filters'); ?></a>
                                <?php
endif; ?>
                            </div>
                        </div>
...
echo translate('admin_chars_table_header', 'Characters'); ?></div>
                        <div class="card-body">
                            <div class="table-wrapper">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th><?php
echo translate('admin_chars_table_char_id', 'Character ID'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_name', 'Name'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_username', 'Username'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_race', 'Race'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_class', 'Class'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_map', 'Map'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_level', 'Level'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_online', 'Online'); ?></th>
                                            <th><?php
echo translate('admin_chars_table_action', 'Action'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
...
echo translate('admin_chars_no_chars_found', 'No characters found.'); ?></td>
                                            </tr>
                                        <?php
else: ?>
                                            <?php
foreach ($characters as $char): ?>
                                                <tr>
                                                    <td><?php
echo htmlspecialchars($char['guid']); ?></td>
                                                    <td><?php
echo htmlspecialchars($char['name']); ?></td>
                                                    <td><?php
echo htmlspecialchars($char['username']); ?></td>
                                                    <td><?php
echo getRaceIcon($char['race'], $char['gender']); ?></td>
                                                    <td><?php
echo getClassIcon($char['class']); ?></td>
                                                    <td><?php
echo htmlspecialchars(isset($map_names[$char['map']]) ? $map_names[$char['map']] : $char['map']); ?></td>
                                                    <td><?php
echo htmlspecialchars($char['level']); ?></td>
                                                    <td><?php
echo getOnlineStatus($char['online']); ?></td>
                                                    <td>
                                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#manageModal-<?php
echo $char['guid']; ?>"><?php
echo translate('admin_chars_manage_button', 'Manage'); ?></button>
                                                    </td>
                                                </tr>
                                                <!-- Manage Character Modal -->
                                                <div class="modal fade" id="manageModal-<?php
echo $char['guid']; ?>" tabindex="-1" aria-labelledby="manageModalLabel-<?php
echo $char['guid']; ?>" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="manageModalLabel-<?php
echo $char['guid']; ?>"><?php
echo translate('admin_chars_manage_modal_title', 'Manage Character: ') . htmlspecialchars($char['name']); ?></h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php
echo translate('admin_chars_close_button', 'Close'); ?>"></button>
                                                            </div>
...
echo translate('admin_chars_label_action', 'Action'); ?></label>
                                                                        <select name="char_action" class="form-select" id="charAction-<?php
echo $char['guid']; ?>" onchange="toggleActionFields(this)">
                                                                            <option value="add_gold"><?php
echo translate('admin_chars_action_add_gold', 'Add Gold'); ?></option>
                                                                            <option value="change_level"><?php
echo translate('admin_chars_action_change_level', 'Change Level'); ?></option>
                                                                            <option value="teleport"><?php
echo translate('admin_chars_action_teleport', 'Teleport (Custom)'); ?></option>
                                                                            <option value="teleport_directly"><?php
echo translate('admin_chars_action_teleport_direct', 'Teleport Directly'); ?></option>
                                                                        </select>
                                                                    </div>
                                                                    <div id="goldFields-<?php
echo $char['guid']; ?>">
                                                                        <div class="mb-3">
                                                                            <label class="form-label"><?php
echo translate('admin_chars_label_gold', 'Gold Amount (in gold)'); ?></label>
                                                                            <input type="number" name="gold" class="form-control" placeholder="<?php
echo translate('admin_chars_placeholder_gold', 'Enter gold amount (e.g., 100)'); ?>" min="0" required>
                                                                        </div>
                                                                    </div>
                                                                    <div id="levelFields-<?php
echo $char['guid']; ?>" style="display: none;">
                                                                        <div class="mb-3">
                                                                            <label class="form-label"><?php
echo translate('admin_chars_label_level', 'Level (1-255)'); ?></label>
                                                                            <input type="number" name="level" class="form-control" placeholder="<?php
echo translate('admin_chars_placeholder_level', 'Enter level (e.g., 80)'); ?>" min="1" max="255" required>
                                                                        </div>
                                                                    </div>
                                                                    <div id="teleportFields-<?php
echo $char['guid']; ?>" style="display: none;">
                                                                        <div class="mb-3">
                                                                            <label class="form-label"><?php
echo translate('admin_chars_label_map', 'Map ID'); ?></label>
                                                                            <select name="map" class="form-select">
                                                                                <?php
foreach ($map_names as $id => $name): ?>
                                                                                    <option value="<?php
echo $id; ?>"><?php
echo $id . ' - ' . htmlspecialchars($name); ?></option>
                                                                                <?php
endforeach; ?>
                                                                            </select>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label"><?php
echo translate('admin_chars_label_x_coord', 'X Coordinate'); ?></label>
                                                                                    <input type="number" step="0.000001" name="x" class="form-control" placeholder="<?php
echo translate('admin_chars_placeholder_x_coord', 'X coordinate'); ?>" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label"><?php
echo translate('admin_chars_label_y_coord', 'Y Coordinate'); ?></label>
                                                                                    <input type="number" step="0.000001" name="y" class="form-control" placeholder="<?php
echo translate('admin_chars_placeholder_y_coord', 'Y coordinate'); ?>" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label"><?php
echo translate('admin_chars_label_z_coord', 'Z Coordinate'); ?></label>
                                                                                    <input type="number" step="0.000001" name="z" class="form-control" placeholder="<?php
echo translate('admin_chars_placeholder_z_coord', 'Z coordinate'); ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="alert alert-info">
                                                                            <?php
echo translate('admin_chars_teleport_tip', 'Tip: Look up coordinates in the game using .gps command.'); ?>
                                                                        </div>
                                                                    </div>
                                                                    <div id="teleportDirectlyFields-<?php
echo $char['guid']; ?>" style="display: none;">
                                                                        <div class="mb-3">
                                                                            <label class="form-label"><?php
echo translate('admin_chars_label_destination', 'Destination'); ?></label>
...
echo translate('admin_chars_cancel_button', 'Cancel'); ?></button>
                                                                        <button type="submit" class="btn btn-primary"><?php
echo translate('admin_chars_apply_button', 'Apply'); ?></button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
...
if ($total_pages > 1): ?>
                                <nav aria-label="<?php
echo translate('admin_chars_pagination_aria', 'Character pagination'); ?>">
                                    <ul class="pagination">
                                        <li class="page-item <?php
echo $page <= 1 ? 'disabled' : ''; ?>">
                                            <a class="page-link" href="<?php
echo $base_path; ?>admin/characters?page=<?php
echo $page - 1; ?>&search_char_name=<?php
echo urlencode($search_char_name); ?>&search_username=<?php
echo urlencode($search_username); ?>&online_filter=<?php
echo urlencode($online_filter); ?>&min_level=<?php
echo urlencode($min_level); ?>&max_level=<?php
echo urlencode($max_level); ?>&sort_id=<?php
echo $sort_id; ?>" aria-label="<?php
echo translate('admin_chars_previous', 'Previous'); ?>">
                                                <span aria-hidden="true">&laquo; <?php
echo translate('admin_chars_previous', 'Previous'); ?></span>
                                            </a>
                                        </li>
                                        <?php
...
echo urlencode($max_level); ?>&sort_id=<?php
echo $sort_id; ?>" aria-label="<?php
echo translate('admin_chars_next', 'Next'); ?>">
                                                <span aria-hidden="true"><?php
echo translate('admin_chars_next', 'Next'); ?> &raquo;</span>
                                            </a>
                                        </li>
                                    </ul>
                                </nav>
...
include $project_root . 'includes/footer.php'; ?>
    ...
    <script src="<?php
echo $base_path; ?>assets/js/pages/admin/characters.js"></script>
</body>
</html>
<?php
$site_db->close();
