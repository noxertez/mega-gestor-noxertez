...
<head>
    ...
    <title><?php
echo translate('page_title_soap', 'SOAP Command Executor'); ?></title>
...
echo $base_path; ?>assets/css/admin/gm_cmd.css">
    <link rel="stylesheet" href="<?php
...
echo translate('soap_title', 'Execute SOAP Command'); ?></h1>
                        ...
                        <form method="post" class="mb-4">
                            <div class="input-group">
                                <input 
                                    ...
                                    placeholder="<?php
echo translate('command_placeholder', '.character level PlayerName 80'); ?>" 
                                    required
                                >
                                <button type="submit" class="btn btn-primary">
                                    <?php
echo translate('run_command', 'Run'); ?>
                                </button>
                            </div>
                        </form>
...
if ($result !== null): ?>
                            <div class="card bg-dark border-secondary">
                                <div class="card-header">
                                    <h2 class="h5 mb-0"><?php
echo translate('response_label', 'Response:'); ?></h2>
                                </div>
