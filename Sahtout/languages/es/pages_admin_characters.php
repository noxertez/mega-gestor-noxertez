...
return [
    ...
    'admin_chars_meta_description' => 'Gestión de personajes para el servidor Sahtout WoW',
    'admin_chars_title' => 'Gestión de Personajes',
    'admin_chars_csrf_missing' => 'Falta el token CSRF.',
    'admin_chars_csrf_error' => 'Falló la validación del token CSRF.',
    'admin_chars_not_found' => 'Personaje no encontrado.',
    'admin_chars_add_gold_success' => 'Se añadieron %d de oro a %s con éxito.',
    'admin_chars_add_gold_failed' => 'No se pudo añadir oro a %s.',
    ...
    'admin_chars_level_success' => 'Nivel cambiado a %d para %s con éxito.',
    'admin_chars_level_failed' => 'No se pudo cambiar el nivel para %s.',
    'admin_chars_level_invalid' => 'El nivel debe estar entre 1 y 255.',
    'admin_chars_teleport_success' => 'Teletransportado %s a %s (%.2f, %.2f, %.2f).',
    'admin_chars_teleport_failed' => 'No se pudo teletransportar a %s.',
    ...
    'admin_chars_placeholder_min_level' => 'por ej., 1',
    'admin_chars_label_max_level' => 'Nivel Máximo',
    'admin_chars_placeholder_max_level' => 'por ej., 255',
    ...
    'admin_chars_action_teleport' => 'Teletransporte (Personalizado)',
    'admin_chars_action_teleport_direct' => 'Teletransporte Directo',
    'admin_chars_label_gold' => 'Cantidad de Oro (en oro)',
    'admin_chars_placeholder_gold' => 'Ingrese la cantidad de oro (por ej., 100)',
    'admin_chars_label_level' => 'Nivel (1-255)',
    'admin_chars_placeholder_level' => 'Ingrese el nivel (por ej., 80)',
    ...
    'admin_chars_teleport_tip' => 'Consejo: Busque las coordenadas en el juego usando el comando .gps.',
    ...
    'admin_chars_race_icon_alt' => 'Ícono de Raza',
    'admin_chars_class_icon_alt' => 'Ícono de Clase',
    'admin_chars_faction_icon_alt' => 'Ícono de Facción',
